                ...
                <div class="products">
                    <div class="row multi-columns-row">
                        <div class="product col-lg-3 col-md-4 col-sm-6 col-xs-6">
                            <div class="product-content">
                                <a href="woocommerce-product-detailed1.php" class="product-thumbnail">
                                    <img class="first-img" src="assets/images/product/product-16.jpg" alt=""/>
                                    <img class="second-img" src="assets/images/product/product-17.jpg" alt=""/>
                                </a>
                        ...
                        <div class="product col-lg-3 col-md-4 col-sm-6 col-xs-6">
                            <div class="product-content">
                                <a href="woocommerce-product-detailed1.php" class="product-thumbnail">
                                    <img class="first-img" src="assets/images/product/product-20.jpg" alt=""/>
