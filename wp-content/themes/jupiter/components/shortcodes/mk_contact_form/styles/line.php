...
<div class="mk-form-row clear">
    ...
    <div class="mk-form-half s_form-all">
        <input type="text" required="required" name="contact_last_name" id="contact_last_name" class="text-input s_txt-input" value="" tabindex="<?php echo $view_params['id']++; ?>" />
...
<div class="mk-form-row clear">
    ...
    <div class="<?php echo (($view_params['phone'] == 'true')? 'mk-form-third s_form-all' : 'mk-form-half s_form-all'); ?>">
        <input type="text" name="contact_website" id="contact_website" class="text-input s_txt-input" value="" tabindex="<?php echo $view_params['id']++; ?>" />
        <label class="ls-text-label">
    ...
    <?php if($view_params['phone'] == 'true') { ?>
        <div class="<?php echo (($view_params['phone'] == 'true')? 'mk-form-third s_form-all' : 'mk-form-half s_form-all'); ?>">
            <input type="text" name="contact_phone" class="text-input s_txt-input two-third" tabindex="<?php echo $view_params['id']++; ?>" />
            <label class="ls-text-label">
