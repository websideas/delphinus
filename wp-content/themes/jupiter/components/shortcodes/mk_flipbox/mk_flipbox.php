...
#flipbox-'.$id.' .front-icon i 		{ font-size:'.$icon_size.'px;'.($icon_color ? ('color:'.$icon_color.';') : '').'}
...
#flipbox-'.$id.' .mk-flipbox-back 	{ '.($back_background_color ? ('background-color: '.$back_background_color.';') : '').'}
	...
	<div class="mk-flipbox-holder _ flex flex-items-stretch width-x2 height-full text-center no-pointer" style="min-height: <?php echo $min_height ?>px">
		...
		<div class="mk-flipbox-front _ flex flex-items-center a_col-1of2 no-backface origin-center bezier-1">
			<div class="mk-flipbox-content _ width-full">
				...
				<div class="front-desc _ padding-x-10-pr"><?php echo $front_desc; ?></div>
			</div>
		</div>

		<div class="mk-flipbox-back _ flex flex-items-center a_col-1of2 fold-back-<?php echo $flip_direction ?> no-backface origin-center bezier-1 pointer">
			<div class="mk-flipbox-content width-full">

				<div class="back-title _ padding-20"><?php echo $back_title; ?></div>
				<div class="back-desc _ padding-x-10-pr"><?php echo $back_desc; ?></div>
