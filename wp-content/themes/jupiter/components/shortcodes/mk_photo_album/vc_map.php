...
vc_map(array(
    ...
    "params" => array(
       ...
       /* array(
        ...
        array(
           "type" => "group_heading",
           "title" => __("Title / Description Styles (on mouse over)", "mk_framework"),
           "param_name" => "description_style_group_title",
           "style" => "border: 0; font-size: 18px; padding:0;",
        ...
        array(
           "type" => "group_heading",
           "title" => __("Overlay Styles (on mouse over)", "mk_framework"),
           "param_name" => "overlay_style_group_title",
           "style" => "border: 0; font-size: 18px; padding:0;",
           "group" => __('Hover Options', 'mk_framework'),
           "dependency" => array(
        ...
        array(
           "type" => "group_heading",
           "title" => __("Cover Image Animation", "mk_framework"),
           "param_name" => "cover_image_animation_title",
           "style" => "border: 0; font-size: 18px; padding:0;",
           "group" => __('Hover Options', 'mk_framework'),
        ),
