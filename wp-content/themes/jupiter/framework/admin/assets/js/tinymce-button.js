...

        {
          ...
          menu: [

            {
              ...
              text: 'Portfolio',
              onclick: function() {
                editor.insertContent('[mk_portfolio style="classic" ajax="false" column="3" permalink_icon="true" count="10" sortable="true" offset="0" height="300" pagination="true" pagination_style="1" order="ASC" orderby="menu_order" target="_self"]');
              }
            }, {
