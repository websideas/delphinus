...
if (!class_exists('Mk_Options_Framework_Fields_Social_Share')) {
    ...
    class Mk_Options_Framework_Fields_Social_Share extends Mk_Options_Framework
    {
        ...
        public function render() {
            ...
            $output.= '<span class="header-social-option-row"><span class="header-social-option-label">Select a Site</span>';
            ...
            $output.= '<span class="header-social-option-row"><span class="header-social-option-label">Enter Full URL</span><input type="text" id="header_social_url" name="header_social_url" size="35" /></span>';
            ...
            if (!empty($this->sites)) {
                foreach ($this->sites as $site) {
                    $output.= '<div class="mk-social-item added-item">
                            <div class="social-item-icon"><i class="mk-jupiter-icon-simple-' . $site . '"></i></div>
                            <div class="social-item-url"></div>
                            <a href="#" class="delete-social-item"><i class="icon-close2"></i></a>
            ...
            $output.= '</div>';
            $output.= '<input type="hidden" value="' . $this->default . '" name="header_social_networks_site" id="header_social_networks_site"/>';
