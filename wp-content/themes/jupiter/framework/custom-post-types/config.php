...
add_filter('manage_edit-edge_columns', 'mk_edit_edge_slider_columns');
...
add_filter('manage_edit-employees_columns', 'mk_edit_employees_columns');
 ...
 */
Mk_Register_custom_taxonomy('faq_category', 'faq');
 ...
 */
Mk_Register_custom_taxonomy('news_category', 'news');
...
add_filter('manage_edit-news_columns', 'mk_edit_news_columns');
...
add_filter('manage_edit-portfolio_columns', 'mk_edit_portfolio_columns');
...
add_filter('manage_edit-testimonial_columns', 'mk_edit_testimonial_columns');
 ...
 */
Mk_Register_custom_taxonomy('photo_album_category', 'photo_album');

function mk_edit_photo_album_columns($columns) {
    $columns = array(
        "cb" => "<input type=\"checkbox\" />",
        'title' => __('Gallery Title', 'mk_framework') ,
        "thumbnail" => __('Conver Photo', 'mk_framework') ,
...
add_filter('manage_edit-photo_album_columns', 'mk_edit_photo_album_columns');
