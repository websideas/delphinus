...
<div class="mk-fullscreen-nav <?php echo $is_repsonive_logo; ?>">
    ...
    <div class="mk-fullscreen-inner _ flex flex-center flex-items-center ">
        <div class="mk-fullscreen-nav-wrapper">
            ...
            <img class="mk-fullscreen-nav-logo dark-logo" alt="<?php echo get_bloginfo('name'); ?>" src="<?php echo $logo; ?>" />
            <img class="mk-fullscreen-nav-logo responsive-logo" alt="<?php echo get_bloginfo('name'); ?>" src="<?php echo $mobile_logo; ?>" />
