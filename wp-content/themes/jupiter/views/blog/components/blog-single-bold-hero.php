...
<div class="mk-blog-hero center-y <?php echo $blog_style; ?>-style js-el" style="background-image:url(<?php echo $hero_image_background; ?>)" data-mk-component="FullHeight">
