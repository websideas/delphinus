...
<div class="mk-social-share">
	<ul>
		<li><a class="mk-blog-print" onClick="window.print()" href="#" title="<?php _e('Print', 'mk_framework'); ?>"><img src="<?php echo THEME_IMAGES; ?>/social-icons/print.svg" alt="print page" /></a></li>
