<?php
	 ...
	 */
	function nm_category_menu_create_list( $category, $current_cat, $categories_menu_divider ) {
	 ...
	 */
	function nm_category_menu( $current_cat, $page_id ) {
			...
			if ( $category->parent != '0' ) {
				...
				if ( $hide_sub ) {
					...
					if ( 
						...
						$sub_output .= nm_category_menu_create_list( $category, $current_cat, $categories_menu_divider );
					}
					continue;
				}
			}
			
			$output .= nm_category_menu_create_list( $category, $current_cat, $categories_menu_divider );
		}
