	...
	Redux::setSection( $opt_name, array(
		...
		'fields'	=> array(
			...
			array(
				'id' 		=> 'top_bar_text',
				'type' 		=> 'editor',
				'title' 	=> __( 'Top Bar Text', 'nm-framework-admin' ),
			...
			array(
				...
				'desc'			=> __( 'Set the logo height.', 'nm-framework-admin'),
				'default'		=> 16,
				'min'			=> 10,
				'max'			=> 250,
				'step'			=> 1,
			...
			array(
				...
				'desc'			=> __( 'Set the logo height for tablet sized screen widths (and the floating header).', 'nm-framework-admin'),
				'default'		=> 16,
				'min'			=> 10,
				'max'			=> 40,
				'step'			=> 1,
			...
			array(
				...
				'desc'			=> __( 'Set the logo height for mobile sized screen widths (and the floating header).', 'nm-framework-admin'),
				'default'		=> 16,
				'min'			=> 10,
				'max'			=> 40,
				'step'			=> 1,
			...
			array(
				'id'		=> 'menu_login',
				'type'		=> 'switch', 
				'title'		=> __( 'Login Menu Widget', 'nm-framework-admin' ),
			...
			array(
				'id'		=> 'menu_cart',
				'type'		=> 'select',
				'title'		=> __( 'Cart Menu Widget', 'nm-framework-admin' ),
			...
			array(
				...
				'type'		=> 'select',
				'title'		=> __( 'Cart Widget Panel Color', 'nm-framework-admin' ),
				'desc'		=> __( 'Select a color scheme for the cart widget slide-panel.', 'nm-framework-admin' ),
	...
	Redux::setSection( $opt_name, array(
		...
		'fields'	=> array(
			array(
				...
				'type'	=> 'info',
				'raw'	=> '<h3 style="margin: 0;">' . __( 'Colors', 'nm-framework-admin' ) . '</h3>'
			...
			array(
				...
				'desc'			=> __( 'Used for the body text.', 'nm-framework-admin' ),
				'default'		=> '#777777',
				'transparent'	=> false,
				'validate'		=> 'color'
			),
			array(
				'id'			=> 'highlight_color',
				'type'			=> 'color',
				'title'			=> __( 'Hightlight Color', 'nm-framework-admin' ),
			...
			array(
				...
				'desc'			=> __( 'Used for the main site background.', 'nm-framework-admin' ),
				'default'		=> '#ffffff',
				'transparent'	=> false,
				'validate'		=> 'color'
			),
			...
			array(
				...
				'desc'			=> __( 'Used for the top bar text.', 'nm-framework-admin' ),
				'default'		=> '#eeeeee',
				'transparent'	=> false,
				'validate'		=> 'color'
			),
			array(
				...
				'type'			=> 'color',
				'title'			=> __( 'Background Color', 'nm-framework-admin' ),
				'desc'			=> __( 'Used for the top bar background.', 'nm-framework-admin' ),
				'default'		=> '#282828',
				'transparent'	=> false,
				'validate'		=> 'color'
			),
			...
			array(
				...
				'desc'			=> __( 'Used for links in the header menu.', 'nm-framework-admin' ),
				'default'		=> '#707070',
				'transparent'	=> false,
				'validate'		=> 'color'
			),
			array(
				...
				'type'		=> 'color',
				'title'		=> __( 'Background Color', 'nm-framework-admin' ),
				'desc'		=> __( 'Used for the header background.', 'nm-framework-admin' ),
				'default'	=> '#ffffff',
				'validate'	=> 'color'
			),
			array(
				...
				'desc'		=> __( 'Used for the header background on the Home page.', 'nm-framework-admin' ),
				'default'	=> '#ffffff',
				'validate'	=> 'color'
			),
			array(
				...
				'desc'		=> __( 'Used for the floating header background.', 'nm-framework-admin' ),
				'default'	=> '#ffffff',
				'validate'	=> 'color'
			),
			array(
				...
				'desc'			=> __( 'Used for the header background when the mobile menu is open.', 'nm-framework-admin' ),
				'default'		=> '#ffffff',
				'transparent'	=> false,
				'validate'		=> 'color'
			),
			array(
				...
				'desc'			=> __( 'Used for the header background on the Login page.', 'nm-framework-admin' ),
				'default'		=> '#f5f5f5',
				'transparent'	=> false,
				'validate'		=> 'color'
			),
			...
			array(
				...
				'type'			=> 'color',
				'title'			=> __( 'Font Color', 'nm-framework-admin' ),
				'desc'			=> __( 'Used for links in the header dropdown menu.', 'nm-framework-admin' ),
				'transparent'	=> false,
				'default'		=> '#a0a0a0',
				'validate'		=> 'color'
			),
			...
			array(
				...
				'type'			=> 'color',
				'title'			=> __( 'Background Color', 'nm-framework-admin' ),
				'desc'			=> __( 'Used for the header dropdown menu.', 'nm-framework-admin' ),
				'default'		=> '#282828',
				'transparent'	=> false,
				'validate'		=> 'color'
			),
			array(
				'id'	=> 'footer_widgets_info_styling',
				'type'	=> 'info',
			...
			array(
				...
				'type'			=> 'color',
				'title'			=> __( 'Font Color', 'nm-framework-admin' ),
				'desc'			=> __( 'Used for the footer widgets text.', 'nm-framework-admin' ),
				'default'		=> '#777777',
				'transparent'	=> false,
				'validate'		=> 'color'
			),
			array(
				...
				'desc'			=> __( 'Used for link hover states.', 'nm-framework-admin' ),
				'default'		=> '#dc9814',
				'transparent'	=> false,
				'validate'		=> 'color'
			),
			array(
				...
				'type'			=> 'color',
				'title'			=> __( 'Background Color', 'nm-framework-admin' ),
				'desc'			=> __( 'Used for the footer widgets background.', 'nm-framework-admin' ),
				'default'		=> '#ffffff',
				'transparent'	=> false,
				'validate'		=> 'color'
			),
			array(
				'id'	=> 'footer_bar_info_styling',
				'type'	=> 'info',
			...
			array(
				...
				'type'			=> 'color',
				'title'			=> __( 'Font Color', 'nm-framework-admin' ),
				'desc'			=> __( 'Used for the footer-bar text.', 'nm-framework-admin' ),
				'default'		=> '#aaaaaa',
				'transparent'	=> false,
				'validate'		=> 'color'
			),
			...
			array(
				...
				'desc'			=> __( 'Used for the menu border on smaller screen widths.', 'nm-framework-admin' ),
				'default'		=> '#3a3a3a',
				'transparent'	=> false,
				'validate'		=> 'color'
			),
			array(
				...
				'type'			=> 'color',
				'title'			=> __( 'Background Color', 'nm-framework-admin' ),
				'desc'			=> __( 'Used for the footer-bar background.', 'nm-framework-admin' ),
				'default'		=> '#282828',
				'transparent'	=> false,
				'validate'		=> 'color'
			),
			array(
				'id'	=> 'shop_info_styling',
				'type'	=> 'info',
			...
			array(
				...
				'type'			=> 'color',
				'title'			=> __( 'Single Product Background', 'nm-framework-admin' ),
			...
			array(
				...
				'desc'			=> __( 'Used for "sale badges" text.', 'nm-framework-admin' ),
				'default'		=> '#373737',
				'transparent'	=> false,
				'validate'		=> 'color'
			),
			array(
				...
				'desc'			=> __( 'Used for "sale badges" background.', 'nm-framework-admin' ),
				'default'		=> '#ffffff',
				'transparent'	=> false,
				'validate'		=> 'color'
			)
	...
	Redux::setSection( $opt_name, array(
		...
		'fields'	=> array(
			...
			array(
				...
				'type'			=> 'slider',
				'title'			=> __( 'Category Columns', 'nm-framework-admin' ),
	...
	Redux::setSection( $opt_name, array(
		...
		'fields'	=> array(
			...
			array (
				...
				'icon'	=> true,
				'type'	=> 'info',
				'raw'	=> '<h3 style="margin: 0;">' . __( 'Shop Header', 'nm-framework-admin' ) . '</h3>',
			),
			array(
				'id'		=> 'shop_header',
				'type'		=> 'switch',
			...
			array(
				...
				'type'		=> 'select',
				'title'		=> __( 'Categories - Order', 'nm-framework-admin' ),
			...
			array(
				...
				'type'		=> 'select',
				'title'		=> __( 'Categories - Order Direction', 'nm-framework-admin' ),
			...
			array(
				...
				'type'		=> 'select',
				'title'		=> __( 'Ajax Filters', 'nm-framework-admin' ),
			...
			array(
				...
				'type'			=> 'slider',
				'title'			=> __( 'Search - Minimum Characters', 'nm-framework-admin' ),
			...
			array(
				...
				'type'		=> 'switch',
				'title'		=> __( 'Search - Titles Only', 'nm-framework-admin' ),
			...
			array (
				...
				'icon'	=> true,
				'type'	=> 'info',
				'raw'	=> '<h3 style="margin: 0;">' . __( 'Shop Category', 'nm-framework-admin' ) . '</h3>',
			),
			array(
			...
			array (
				...
				'icon'	=> true,
				'type'	=> 'info',
				'raw'	=> '<h3 style="margin: 0;">' . __( 'Shop Catalog', 'nm-framework-admin' ) . '</h3>',
			),
			array(
				'id'			=> 'shop_columns',
				'type'			=> 'slider',
			...
			array(
				...
				'type'			=> 'slider',
				'title'			=> __( 'Product Image Column', 'nm-framework-admin' ),
			...
			array(
				...
				'type'			=> 'slider',
				'title'			=> __( 'Product Image Size (Single column view)', 'nm-framework-admin' ),
				'desc'			=> __( 'Select a max-size for the product image when displayed in a single column (on smaller screen sizes).', 'nm-framework-admin' ),
				'default'		=> 500,
				'min'			=> 100,
				'max'			=> 1220,
				'step'			=> 1,
			...
			array(
				...
				'type'		=> 'switch',
				'title'		=> __( 'Product Image Zoom', 'nm-framework-admin' ),
				'desc'		=> __( 'Zoom to view full-size product image.', 'nm-framework-admin' ),
				'default'	=> 1,
				'on'		=> 'Enable',
				'off'		=> 'Disable'
			),
			...
			array(
				...
				'type'		=> 'select',
				'title'		=> __( 'Product Description Layout', 'nm-framework-admin' ),
