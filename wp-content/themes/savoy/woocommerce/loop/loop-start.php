...
// Class
$columns_class = 'small-block-grid-' . $columns_small . ' medium-block-grid-' . $columns_medium . ' large-block-grid-' . $columns_large;

?>

<ul class="nm-products products <?php echo $columns_class; ?>">
