<?php
	...
	if ( nm_woocommerce_activated() ) {
		...
		if ( is_admin() && $nm_theme_options['product_hover_image_global'] !== '1' ) {
			// WooCommerce: Product details meta box
			include( NM_DIR . '/woocommerce/admin/product-details-meta-box.php' );
	...
	function nm_styles() {
		...
		if ( nm_woocommerce_activated() ) {
			...
			if ( is_product() ) {
				...
				// Cart widget: Disable on cart and checkout pages
