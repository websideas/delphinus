...
<div id="reviews" class="row">
		...
		<div id="review_form_wrapper" class="col-md-5 col-md-offset-1">
			<div id="review_form">
				<?php
					...
					$comment_form = array(
						'title_reply'          => have_comments() ? __( 'Here you can review this item.', 'delphinus' ) : sprintf( __( 'Be the first to review &ldquo;%s&rdquo;', 'woocommerce' ), get_the_title() ),
					...
					if ( get_option( 'woocommerce_enable_review_rating' ) === 'yes' ) {
                        $comment_form['submit_button'] = '<span class="comment-form-rating"><label for="rating">' . __( 'Your Rating', 'woocommerce' ) .'</label><select name="rating" id="rating">
                    ...
                    $comment_form['submit_button'] .= '<span class="comment-form-button"><button name="%1$s" type="submit" id="%2$s" class="%3$s">%4$s</button></span>';
	...
	<?php else : ?>
		...
		<p class="woocommerce-verification-required col-md-offset-1 col-md-5"><?php _e( 'Only logged in customers who have purchased this product may leave a review.', 'woocommerce' ); ?></p>
