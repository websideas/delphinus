    ...
    <div class="container">
        <div class="related-products-wrapper">
            <div class="kt-heading text-center">
                ...
                <h3 class="kt-heading-title"><?php _e( 'Related Products', 'woocommerce' ); ?></h3>
            </div>


            <div class="owl-carousel-kt navigation-center-outside  navigation-normal">
                <div class="wc-carousel-wrapper" data-options='<?php echo esc_attr(apply_filters('kt_wc_product_carousel', '{"desktop": "4","desktopsmall": "3","tablet": "2","mobile": "1","pagination": false,"navigation": true}')) ?>'>
