    ...
    <div class="container-megamenu">
        <p class="field-icon description description-wide clearfix">
            <label for="menu-item-icon-<?php echo $item_id; ?>">
                <?php _e( 'Select icon of this item (set empty to hide). Ex: fa fa-home', 'adroit'); ?><br />
        ...
        <div class="wrapper-megamenu">
            <p class="field-enable description description-wide">
                <label for="menu-item-enable-<?php echo $item_id; ?>">
                    ...
                    <b><?php _e( 'Enable Mega Menu (only for main menu)', 'adroit'); ?></b>
                </label>
            </p>
            <div id="content-megamenu-<?php echo $item_id; ?>" class="megamenu-layout clearfix">
                <div class="megamenu-layout-depth-0">
                    <p class="field-columns description description-wide">
                        <label for="menu-item-columns-<?php echo $item_id; ?>">
                            <?php _e( 'Mega Menu number of columns', 'adroit'); ?><br />
                    ...
                    <p class="field-layout description description-wide">
                        <label for="menu-item-layout-<?php echo $item_id; ?>">
                            <?php _e( 'Mega Menu layout', 'adroit'); ?><br />
                            <select id="menu-item-layout-<?php echo $item_id; ?>" name="menu-item-megamenu-layout[<?php echo $item_id; ?>]" class="widefat edit-menu-item-layout">
                                <option <?php selected($item->layout, 'default'); ?> value="default"><?php _e('Default', 'adroit'); ?></option>
                                <option <?php selected($item->layout, 'table'); ?> value="table"><?php _e('Table + Border', 'adroit'); ?></option>
                            </select>
                        </label>
                    </p>
                    <p class="field-width description description-wide">
                        <label for="menu-item-width-<?php echo $item_id; ?>">
                            <?php _e( 'Mega Menu width', 'adroit'); ?><br />
                            <select id="menu-item-width-<?php echo $item_id; ?>" name="menu-item-megamenu-width[<?php echo $item_id; ?>]" class="widefat edit-menu-item-width">
                                <option <?php selected($item->width, 'full'); ?> value="full"><?php _e('Full Width', 'adroit'); ?></option>
                                <option <?php selected($item->width, 'half'); ?> value="half"><?php _e('1/2', 'adroit'); ?></option>
                                <option <?php selected($item->width, 'three'); ?> value="three"><?php _e('3/4', 'adroit'); ?></option>
                                <option <?php selected($item->width, 'four'); ?> value="four"><?php _e('4/5', 'adroit'); ?></option>
                                <option <?php selected($item->width, 'five'); ?> value="five"><?php _e('9/10', 'adroit'); ?></option>
                            </select>
                        </label>
                    </p>
                    <p class="description description-position description-wide">
                        <label>
                            <?php _e( 'Mega menu position', 'adroit'); ?><br />
                            <select id="menu-item-position-<?php echo $item_id; ?>" name="menu-item-megamenu-position[<?php echo $item_id; ?>]" class="widefat edit-menu-item-position">
                                ...
                                <option <?php selected($item->position, 'left-menubar'); ?> value=""><?php _e( 'Left edge of menu bar', 'adroit'); ?></option>
                                <option <?php selected($item->position, 'right-menubar'); ?> value="right-menubar"><?php _e( 'Right edge of menu bar', 'adroit'); ?></option>
                                <option <?php selected($item->position, 'left-parent'); ?> value="left-parent"><?php _e( 'Left Edge of Parent item', 'adroit'); ?></option>
                                <option <?php selected($item->position, 'right-parent'); ?> value="right-parent"><?php _e( 'Right Edge of Parent item', 'adroit'); ?></option>
                            </select>
                        </label>
                    </p>
                </div>
                <div class="megamenu-layout-depth-1">
                    <p class="field-image description description-wide">
                        ...
                        <span class="clearfix"></span>
                        <input type="button" class="button-secondary kt_image_menu" value="<?php _e('Upload image', 'adroit'); ?>" style="width: 100%;" />
                    </p>
                    <p class="field-clwidth description description-wide">
                        <label for="menu-item-clwidth-<?php echo $item_id; ?>">
                            <?php _e( 'Mega Menu Column Width - Overrides parent colum (in percentage, ex: 30%)', 'adroit'); ?><br />
                    ...
                    <p class="field-columntitle description description-wide">
                        <label for="menu-item-columntitle-<?php echo $item_id; ?>">
                            ...
                            <?php _e('Disable Mega Menu Column Title', 'adroit'); ?>
                        </label>
                    </p>
                    <p class="field-columnlink description description-wide">
                        <label for="menu-item-columnlink-<?php echo $item_id; ?>">
                            ...
                            <?php _e('Disable Mega Menu Column Link', 'adroit'); ?>
                        </label>
                    </p>
                    <p class="field-endrow description description-wide">
                        <label for="menu-item-endrow-<?php echo $item_id; ?>">
                            ...
                            <?php _e( 'End Row (Clear the next row and start a new one with next item)', 'adroit'); ?>
                        </label>
                    </p>
                    <p class="field-widget description description-wide">
                        <label for="menu-item-widget-<?php echo $item_id; ?>">
                            <?php _e('Mega Menu Widget Area', 'adroit'); ?><br />
                            ...
                            <select id="menu-item-widget-<?php echo $item_id; ?>" name="menu-item-megamenu-widget[<?php echo $item_id; ?>]" class="widefat edit-menu-item-widget">
                                <option value="0"><?php _e( 'Select Widget Area', 'adroit'); ?></option>
