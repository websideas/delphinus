...
class WPBakeryShortCode_KT_Products_Mini extends WPBakeryShortCode {
    protected function content($atts, $content = null) {
        ...
        $elementClass = array(
            'base' => apply_filters( VC_SHORTCODE_CUSTOM_CSS_FILTER_TAG, 'kt-products-mini', $this->settings['base'], $atts ),
        ...
        if ( $products->have_posts() ) :
            ...
            while ( $products->have_posts() ) : $products->the_post();
                wc_get_template_part( 'content', 'product_mini' );
...
vc_map( array(
    "name" => esc_html__( "KT: Products Mini", 'delphinus'),
    "base" => "kt_products_mini",
