(function($){
    ...
    $(window).load(function(){
        ...
        if (typeof Pace != "undefined") {
            var pageLoadingContent = false;
            var pageLoadingProgressInterval = setInterval(function () {
                try {
                    if (!pageLoadingContent) {
                        $('.page-loading-wrapper').appendTo('.pace-activity');
                        pageLoadingContent = true;
                    }
                    if ($('body').hasClass("pace-done")) {
                        clearInterval(pageLoadingProgressInterval);
                    }
        ...
        if(_body.hasClass('page-type-bullet')){
            ...
            if($lists.length) {
                $lists.each(function (i) {
                    ...
                    $items += '<li><a href="#'+$link+'" data-item="' + i + '"><span></span></a></li>';
                });
