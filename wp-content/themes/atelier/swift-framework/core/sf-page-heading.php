    ...
    */
    ...
    if ( ! function_exists( 'sf_page_heading' ) ) {
        function sf_page_heading() {
            ...
            $shop_page  = false;
            $page_title = $page_subtitle = $page_title_style = $page_title_overlay_effect = $fancy_title_image_url = $article_heading_bg = $article_heading_text = $page_heading_el_class = $page_heading_wrap_el_class = $page_design_style = $extra_styles = $page_title_text_align = "";
