...
<!-- header-full-center -->
<header id="header" class="<?php echo $shadow; ?> header-full-center navigation-center">
    <?php include_once('templates/top-bar-3.php'); ?>
    <div class="navbar-container sticky-header">
        <div class="navbar-container-inner clearfix">
            ...
            <?php include_once('templates/nav-3.php'); ?>
        </div>
